...
INSERT INTO "new_Event" ("coverImage", "createdAt", "currency", "description", "endAt", "id", "isFeatured", "isOnline", "organizerId", "priceCents", "slug", "startAt", "status", "timezone", "title", "updatedAt", "venueId") SELECT "coverImage", "createdAt", "currency", "description", "endAt", "id", "isFeatured", "isOnline", "organizerId", "priceCents", "slug", "startAt", "status", "timezone", "title", "updatedAt", "venueId" FROM "Event";
DROP TABLE "Event";
